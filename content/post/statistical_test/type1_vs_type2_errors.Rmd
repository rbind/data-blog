...
Type 1 and type 2 error rates are denoted by $\alpha$ and $\beta$, respectively. The power of a statistical test is defined by $1 - \beta$. These rates depend on several factors:

* **Effect size:** error rates are smaller for larger effect sizes
* **Sample size:** tests need to be sufficiently powered to be able to correctly reject the null hypothesis
* **Significance level:** power decreases with increasing stringency of significance levels

Traditionally, the type 1 error rate is limited using a significance level of 5%. Experiments are often designed for a power of 80%. 

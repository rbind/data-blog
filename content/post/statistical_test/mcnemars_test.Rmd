...
McNemar's test is a test for contingency tables that arise from paired measurements. In contrast to the $\chi^2$ test, which is a test for independence, McNemar's test is a test for symmetry (also called marginal homogeneity). Still, McNemar's test is related to the chi-squared test because its test static also follows a $\chi^2$ distribution.

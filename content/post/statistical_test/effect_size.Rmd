...
To illustrate what can happen at a very large sample size, let's generate a data set with an even larger sample size and a smaller difference between the groups. We'll take a sample of 1 million and artificially enforce a difference between the groups of only $1\%$:

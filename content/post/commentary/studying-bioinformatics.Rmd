...
lead: "Prospects as a bioinformatics graduate"
author: Matthias Döring
date: '2019-11-03'
description: "Learn from my experiences studying Bioinformatics as a Bachelor's, Master's, and as a PhD. What kind of career opportunities exist?"
slug: "studying-bioinformatics-is-it-worth-it"
downloadRmd: false
categories:
  - commentary
tags:
thumbnail: "/post/commentary/studying-bioinformatics_avatar.jpeg"
---
...
Some people [advise against studying bioinformatics](https://www.reddit.com/r/bioinformatics/comments/3ennsp/dont_study_bioinformatics/) because it is supposed to be difficult to find a job afterwards. I didn't have that experience at all and I received many job offers from recruiters. I would argue that, having a bioinformatics degree, job prospects are fine, considering that bioinformaticians have a special skill set, which makes them attractive for companies:

* Bioinformatics graduates exhibit the characteristics of [T-shaped professionals](https://medium.com/@warren2lynch/scrum-team-i-shaped-vs-t-shaped-people-569de6fa494e). This allows them to perform a variety of tasks and to act as facilitators in interdisciplinary teams.
...
For more advice on studying, you can also check the excellent studying tips at [Study Prep Lounge](https://studypreplounge.com).

...
1. Rashomon: there is a multiplicity of good models
2. Occam: we would like to have the simplest possible model but what about the accuracy?
3. Bellman: curse or blessing of dimensionality?

* Rashomon is a famous 1950 feature film in which various characters depict different and even contradictory versions of the same incident.
* William of Occam's razor states that *Entities should not be multiplied beyond necessity*, underlining the importance of simplicity.
* Richard Bellman coined the term *curse of dimensionality*.

...
Additional functions for multivariate time-series data are available via the [MTS package](https://cran.r-project.org/web/packages/MTS/MTS.pdf). For irregular time-series data, the [XTS](https://www.datacamp.com/community/blog/r-xts-cheat-sheet) and [zoo](https://cran.r-project.org/web/packages/zoo/zoo.pdf) packages are useful. 

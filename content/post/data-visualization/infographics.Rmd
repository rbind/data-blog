...
categories:
  - data-visualization
tags:
thumbnail: "/post/data-visualization/infographics_cover.jpg"
...
The only diadvantage of the free version of [easelly](https://www.easel.ly/) is that not all templates/graphics are available.
...
What I like is the consistent black/green color scheme, which makes for the infographic look quite professional. The infographic uses up the available space well. An advantage over the infographic created with Venngage is that the visuals are more dominating. A disadvantage of the dark template is that you have to adjust most custom images to light colors.
